...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-cream px-4">
      <Card className="w-full max-w-md shadow-none border-border/50">
        <CardHeader className="text-center">
          ...
          <p className="text-sm text-muted-foreground">Start coordinating your wedding day</p>
        </CardHeader>
        <CardContent>
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            ...
            <Link href="/auth/login" className="font-medium text-sage hover:text-sage-dark">
              Sign in
            </Link>
          </p>
        </CardContent>
